...
public class Player extends Sprite {
    ...
    public Player(int x, int y, BufferedImage[] projectileImages, PlayerController controller, int playerNum, GamePanel gp) {
        ...
        this.rect.width = Settings.BASE_TILE_SIZE - 2;
        this.rect.height = Settings.BASE_TILE_SIZE - 2;

        this.platformRect = new Rectangle();
        this.platformRect.x = this.x;
        this.platformRect.y = this.y + Settings.BASE_TILE_SIZE;
        this.platformRect.width = Settings.BASE_TILE_SIZE;
        this.platformRect.height = Settings.BASE_TILE_SIZE / 4;

        this.ropeRect = new Rectangle();
        this.ropeRect.x = this.x + 3;
        this.ropeRect.y = this.y;
        this.ropeRect.width = 2;
        this.ropeRect.height = Settings.BASE_TILE_SIZE;
            ...
            for (Tile tile : gp.spriteManager.allTiles) {
                ...
                if (!tile.id.equals("60") && tile.solid && this.rect.intersects(tile.rect)) {
                    ...
                    if (this.speedX < 0) {
                        ...
                        this.x = tile.x + Settings.BASE_TILE_SIZE;
            ...
            for (Tile tile : gp.spriteManager.allTiles) {
                ...
                if (!tile.id.equals("60") && tile.solid && this.rect.intersects(tile.rect)) {
                    ...
                    if (this.speedY < 0) {
                        ...
                        this.y = tile.y + Settings.BASE_TILE_SIZE;
            ...
            for (Tile tile : gp.spriteManager.allPlatformTiles) {
                ...
                if (this.platformRect.intersects(tile.rect)) {
                    ...
                    if (this.speedY > 0) {
                        ...
                        this.y = tile.y - Settings.BASE_TILE_SIZE - 1;
                        this.onGround = true;
                        this.hasShotDown = false;
                        this.collidedBottom = true;
    ...
    public void limitScrolling() {
        ...
        if (gp.spriteManager.lockedLeft) {
            ...
            this.drawX = (Settings.BASE_SCREEN_WIDTH / 2) - (this.width / 2);
        ...
        if (gp.spriteManager.lockedTop) {
            ...
            this.drawY = (Settings.BASE_SCREEN_HEIGHT / 2) - (this.height / 2);
    ...
    public void draw(Graphics2D g2) {
        ...
        if (gp.controllerManager.playerCount == 2) {
            ...
            spritesheet.drawTextNoBG(g2, "P" + this.playerNum, this.drawX - Settings.BASE_TILE_SIZE / 2, this.drawY - Settings.BASE_TILE_SIZE, new String[] {"custom", "custom"});
