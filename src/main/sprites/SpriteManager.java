...
public class SpriteManager {
    ...
    public void getMapStr() {
        ...
        try {
            ...
            totalMapWidth = mapWidth * Settings.BASE_TILE_SIZE;
            totalMapHeight = mapHeight * Settings.BASE_TILE_SIZE;
    ...
    public void parseMapData() {
        ...
        for (int y = 0; y < mapHeight; y++) {
            ...
            for (int x = 0; x < mapWidth; x++) {
                ...
                mapPositionData.add(new int[] {x * Settings.BASE_TILE_SIZE, y * Settings.BASE_TILE_SIZE});
